...
declare class ColorKeys {
    colorString: string;
    appendColors(stringBuilder: string, xpoUrlColors: Array<XpoUrlObject>): string;
}
declare class DesignKey {
    private keyList;
    private americanCulture;
    constructor();
    addToList(value: any, omitIfDefault?: boolean): void;
    addDouble(value: number, omitIfDefault?: boolean): void;
    getUrlValue(): string;
...
declare class DesignKeys {
    private designKeys;
    constructor();
    appendDesigns(stringBuilder: string, xpoUrlDesigns: Array<XpoUrlObject>): string;
}
...
declare class EntityNameDesignKey extends DesignKey {
    getValues(designs: Array<XpoUrlObject>): string;
    convertToBase64UrlString(value: string): string;
}
...
declare class OverlayKey {
    ...
    addDouble(value: number, omitIfDefault?: boolean): void;
    getUrlValue(): string;
    getValues(designs: Array<XpoUrlOverlay>): string;
    addEmpty(): void;
    isEmpty(): boolean;
}
declare class OverlayKeys {
    private overlayKeys;
    constructor();
    appendOverlays(stringBuilder: string, xpoUrlOverlays: Array<XpoUrlOverlay>): string;
}
declare class LocationOverlayKey extends OverlayKey {
    getValues(overlays: Array<XpoUrlOverlay>): string;
}
...
declare class XpoUrlGenerator implements UrlGeneratorModule.IXpoUrlGenerator, UrlGeneratorModule.IXpoCanvasGenerator {
    ...
    getCanvas(request: XpoUrlRequest): any;
    getImageUrl(request: XpoImageUrlRequest): string;
    getCoordsUrl(request: XpoCoordinatesUrlRequest): string;
    getXpoBaseUrl(urlRequest: XpoUrlRequest): string;
    getDesignImageUrl(design: XpoUrlDesign, urlRequest: XpoUrlRequest): string;
    ensureWorkspace(canvasContainerId: string): void;
}
...
declare class TextKey {
    ...
    addDouble(value: number, omitIfDefault?: boolean): void;
    getUrlValue(): string;
    getValues(texts: Array<XpoUrlObject>): string;
    addEmpty(): void;
    isEmpty(): boolean;
}
declare class TextKeys {
    private textKeys;
    constructor();
    appendTexts(stringBuilder: string, xpoUrlTexts: Array<XpoUrlObject>): string;
}
...
declare class FluentXpoUrlColor {
    ...
    getXpoUrlColor(): XpoUrlColor;
}
declare class FluentXpoUrlDesign {
    xpoUrlDesign: XpoUrlDesign;
    constructor(fileName: string);
    getXpoUrlDesign(): XpoUrlDesign;
    setSameIndex(index: number): FluentXpoUrlDesign;
    setType(type: UrlGeneratorModule.XpoUrlObjectTypes): FluentXpoUrlDesign;
    setWidth(width: number): FluentXpoUrlDesign;
    setHeight(height: number): FluentXpoUrlDesign;
    setGloss(gloss: number): FluentXpoUrlDesign;
    setContrast(contrast: number): FluentXpoUrlDesign;
    setDropX(dropX: number): FluentXpoUrlDesign;
    setDropY(dropY: number): FluentXpoUrlDesign;
    setPlacingPointX(placingPointX: number): FluentXpoUrlDesign;
    setPlacingPointY(placingPointY: number): FluentXpoUrlDesign;
    setRotation(rotation: number): FluentXpoUrlDesign;
    setFlip(flip: boolean): FluentXpoUrlDesign;
    setRepeat(repeat: boolean): FluentXpoUrlDesign;
    setAspectRatio(aspectRatio: boolean): FluentXpoUrlDesign;
}
declare class FluentXpoUrlFactory implements UrlGeneratorModule.IFluentXpoUrlFactory {
    createFluentUrlGenerator(generator: UrlGeneratorModule.IXpoUrlGenerator, urlType: UrlGeneratorModule.FluentXpoUrlType, canvasGenerator?: UrlGeneratorModule.IXpoCanvasGenerator): FluentXpoUrlGenerator;
    getUrlRequest(urltype: UrlGeneratorModule.FluentXpoUrlType): XpoImageUrlRequest;
}
declare class FluentXpoUrlGenerator implements UrlGeneratorModule.IFluentXpoUrlGenerator {
    ...
    setPrimaryKey(primaryKey: string): FluentXpoUrlGenerator;
    setOutputQuality(outputQuality: number): FluentXpoUrlGenerator;
    setOutputType(outputType: UrlGeneratorModule.XpoUrlOutputTypes): FluentXpoUrlGenerator;
    addObject(xpoObject: Function, options?: any): FluentXpoUrlGenerator;
    addTemplateParameter(index: number, parameterValue: string): FluentXpoUrlGenerator;
    addOverlay(xpoOverlay: Function, options: any): FluentXpoUrlGenerator;
    setEntityType(fileType: UrlGeneratorModule.XpoUrlFileTypes): FluentXpoUrlGenerator;
    setWidth(width: number): FluentXpoUrlGenerator;
    setHeight(height: number): FluentXpoUrlGenerator;
    setResizeMethod(resizeMethod: UrlGeneratorModule.XpoUrlResizeMethods): FluentXpoUrlGenerator;
    setImageType(type: UrlGeneratorModule.XpoUrlImageTypes): FluentXpoUrlGenerator;
    setDebug(debug: boolean): FluentXpoUrlGenerator;
    setBackgroundColor(colorString: string): FluentXpoUrlGenerator;
    setCaching(cache: boolean): FluentXpoUrlGenerator;
    setDesignCaching(cache: boolean): FluentXpoUrlGenerator;
    setHighlightObject(objectNumber: number): FluentXpoUrlGenerator;
    setTransparencyColor(colorString: string): FluentXpoUrlGenerator;
    setSceneThumbnailObjectNumber(objectNumber: number): FluentXpoUrlGenerator;
    setAllColor(colorString: string): FluentXpoUrlGenerator;
    setPrefillCaching(cache: boolean): FluentXpoUrlGenerator;
    setTemplateName(name: string): FluentXpoUrlGenerator;
    setAbsoluteUrl(absoluteUrl: string): FluentXpoUrlGenerator;
    setWatermarkImage(watermarkImageName: string): FluentXpoUrlGenerator;
    addCustom(key: string, value: Object): FluentXpoUrlGenerator;
...
declare class FluentXpoUrlObject {
    private xpoObject;
    constructor();
    getXpoObject(): XpoUrlObject;
    setIndex(index: number): FluentXpoUrlObject;
    design(fileName: string): FluentXpoUrlDesign;
    text(text: string): FluentXpoUrlText;
    color(color: string): FluentXpoUrlColor;
}
declare class FluentXpoUrlOverlay {
    private xpoUrlOverlay;
    constructor(overlayName?: string);
    getXpoOverlay(): XpoUrlOverlay;
    setIndex(index: number): FluentXpoUrlOverlay;
    setLocation(location: UrlGeneratorModule.XpoUrlOverlayLocations): XpoUrlOverlay;
    setMode(mode: UrlGeneratorModule.XpoUrlOverlayModes): XpoUrlOverlay;
    setName(name: string): XpoUrlOverlay;
    setOperation(operation: UrlGeneratorModule.XpoUrlOverlayOperations): XpoUrlOverlay;
    setTime(time: UrlGeneratorModule.XpoUrlOverlayTimes): XpoUrlOverlay;
}
declare class FluentXpoUrlText {
    private xpoUrlText;
    constructor(text: string);
    getXpoUrlText(): XpoUrlText;
    setFontName(fontName: string): FluentXpoUrlText;
    setFontSize(fontSize: number): FluentXpoUrlText;
    setColor(color: string): FluentXpoUrlText;
    setAlignment(alignment: UrlGeneratorModule.XpoUrlTextAlignment): FluentXpoUrlText;
    setFontStyle(fontStyle: UrlGeneratorModule.TextFontStyle): FluentXpoUrlText;
    setDropX(dropX: number): FluentXpoUrlText;
    setDropY(dropY: number): FluentXpoUrlText;
    setPlacingPointX(placingPointX: number): FluentXpoUrlText;
    setPlacingPointY(placingPointY: number): FluentXpoUrlText;
    setRotation(rotation: number): void;
    setMultiplier(multiplier: number): FluentXpoUrlText;
}
...
declare module UrlGeneratorModule {
    interface IFluentXpoUrlGenerator {
        ...
        setSceneRenderMode(mode: UrlGeneratorModule.XpoUrlRenderModes): any;
...
declare class XpoUrlDesign {
    ...
    getSameIndex(): number;
    setSameIndex(val: number): void;
    getObjectType(): UrlGeneratorModule.XpoUrlObjectTypes;
    setObjectType(val: UrlGeneratorModule.XpoUrlObjectTypes): void;
    ...
    getGloss(): number;
    setGloss(val: number): void;
    getContrast(): number;
    setContrast(val: number): void;
    getDropX(): number;
    setDropX(val: number): void;
    getDropY(): number;
    setDropY(val: number): void;
    getPlacingPointX(): number;
    setPlacingPointX(val: number): void;
    getPlacingPointY(): number;
    setPlacingPointY(val: number): void;
    getRotation(): number;
    ...
    setAspectRatio(val: boolean): void;
}
declare class XpoUrlObject {
    ...
    setObjectType(val: UrlGeneratorModule.XpoUrlObjectTypes): void;
    getText(): XpoUrlText;
    setText(val: XpoUrlText): void;
    getColor(): XpoUrlColor;
    setColor(val: XpoUrlColor): void;
    getDesign(): XpoUrlDesign;
    setDesign(val: XpoUrlDesign): void;
}
declare class XpoUrlOverlay {
    ...
    setOverlayName(val: string): void;
    getOverlayMode(): UrlGeneratorModule.XpoUrlOverlayModes;
    setOverlayMode(val: UrlGeneratorModule.XpoUrlOverlayModes): void;
    getOverlayTime(): UrlGeneratorModule.XpoUrlOverlayTimes;
    setOverlayTime(val: UrlGeneratorModule.XpoUrlOverlayTimes): void;
    getOverlayOperation(): UrlGeneratorModule.XpoUrlOverlayOperations;
    setOverlayOperation(val: UrlGeneratorModule.XpoUrlOverlayOperations): void;
    getOverlayLocation(): UrlGeneratorModule.XpoUrlOverlayLocations;
    setOverlayLocation(val: UrlGeneratorModule.XpoUrlOverlayLocations): void;
}
declare class XpoUrlRequest {
    ...
    setPrimaryKey(val: string): void;
    getOutputType(): UrlGeneratorModule.XpoUrlOutputTypes;
    setOutputType(val: UrlGeneratorModule.XpoUrlOutputTypes): void;
    getOutputQuality(): number;
    setOutputQuality(val: number): void;
    getObjects(): Array<XpoUrlObject>;
    getTemplateParameters(): Array<XpoUrlTemplate>;
    getOverlays(): Array<XpoUrlOverlay>;
    getFileType(): UrlGeneratorModule.XpoUrlFileTypes;
    setFileType(val: UrlGeneratorModule.XpoUrlFileTypes): void;
    getWidth(): number;
    setWidth(val: number): void;
    getHeight(): number;
    setHeight(val: number): void;
    getResizeMethod(): UrlGeneratorModule.XpoUrlResizeMethods;
    setResizeMethod(val: UrlGeneratorModule.XpoUrlResizeMethods): void;
    getImageType(): UrlGeneratorModule.XpoUrlImageTypes;
    setImageType(val: UrlGeneratorModule.XpoUrlImageTypes): void;
    getDebug(): boolean;
    setDebug(val: boolean): void;
    getBackgroundColor(): string;
    setBackgroundColor(val: string): void;
    getTransparencyColor(): string;
    setTransparencyColor(val: string): void;
    getAllColor(): string;
    setAllColor(val: string): void;
    getTemplateName(): string;
    setTemplateName(val: string): void;
    getCaching(): boolean;
    setCaching(val: boolean): void;
    getDesignCaching(): boolean;
    setDesignCaching(val: boolean): void;
    getPreFillCaching(): boolean;
    setPreFillCaching(val: boolean): void;
    getIsEntity(): boolean;
    setIsEntity(val: boolean): void;
    getHighlightObject(): number;
    setHighlightObject(val: number): void;
    getSceneThumbnailObjectNumber(): number;
    setSceneThumbnailObjectNumber(val: number): void;
    getAbsoluteUrl(): string;
    setAbsoluteUrl(val: string): void;
    getWatermarkImage(): string;
    setWatermarkImage(val: string): void;
    getFrame(): number;
    setFrame(val: number): void;
    getSceneRenderMode(): UrlGeneratorModule.XpoUrlRenderModes;
    setSceneRenderMode(val: UrlGeneratorModule.XpoUrlRenderModes): void;
...
declare class XpoUrlText {
    ...
    getAlignment(): UrlGeneratorModule.XpoUrlTextAlignment;
    setAlignment(val: UrlGeneratorModule.XpoUrlTextAlignment): void;
    getFontStyle(): UrlGeneratorModule.TextFontStyle;
    setFontStyle(val: UrlGeneratorModule.TextFontStyle): void;
    getDropX(): number;
    setDropX(val: number): void;
    getDropY(): number;
    setDropY(val: number): void;
...
declare module UrlGeneratorModule {
    ...
    function getMaxObjectNumber(xpoUrlObjects: Array<XpoUrlObject>): number;
    function getMaxOverlayNumber(xpoUrlOverlays: Array<XpoUrlOverlay>): number;
}
