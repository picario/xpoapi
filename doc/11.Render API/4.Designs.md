...
![Design contrast](/Doc/11.Render%20Api/images/texture_contrast.png "Design contrast")
...
![Design drop X](/Doc/11.Render%20Api/images/dropx.png "Design drop X")

The following images show the effect of different values for Drop Y.

![Design drop Y](/Doc/11.Render%20Api/images/dropy.png "Design drop Y")
...
![Design placing point X and Y](/Doc/11.Render%20Api/images/placingpoint.png "Design placing point X and Y")
